...
export const MODEL = import.meta.env.MODELS_URL;
...
export const MODELS_ROUTES = "/api/models";
// export const CHECK_NSFW_IMAGE_ROUTE = `${MODELS_ROUTES}/classifyNSFW`;
export const CHECK_NSFW_IMAGE_ROUTE = "http://localhost:9000/api/models/classifyNSFW";
