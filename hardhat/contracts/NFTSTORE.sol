...
contract NFTSTORE is ERC721URIStorage {     // NFTSTORE is inheriting ERC721URIStorage
    ...
    constructor() ERC721("NFTSTORE", "NFTS") {      // will only run once (when contract is deployed)
